...
[Data Dictionary](https://github.com/Weidsn/capstone_project/blob/main/Readme.txt), including a list of files for running the Machine Learning models (actual data files are too large to be uploaded).
